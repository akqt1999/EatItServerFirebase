...
public class MyBestDealsAdapter extends RecyclerView.Adapter<MyBestDealsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Glide.with(context).load(bestDealModelList.get(position).getImage()).into(holder.imgCategory);
        holder.txtCategory.setText(new StringBuilder(bestDealModelList.get(position).getName()));
